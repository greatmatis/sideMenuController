...
class MainViewController: LGSideMenuController {
    ...
    func setup(type: UInt) {
        ...
        if (self.storyboard != nil) {
            ...
            leftViewBackgroundColor = UIColor(red: 1.0, green: 0.0, blue: 1.0, alpha: 0.05)
            rootViewCoverColorForLeftView = UIColor(red: 1.0, green: 0.0, blue: 1.0, alpha: 0.05)
        ...
        let greenCoverColor = UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 0.3)
        let purpleCoverColor = UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 0.3)
        ...
        case 1:
            ...
            rootViewCoverColorForLeftView = purpleCoverColor
